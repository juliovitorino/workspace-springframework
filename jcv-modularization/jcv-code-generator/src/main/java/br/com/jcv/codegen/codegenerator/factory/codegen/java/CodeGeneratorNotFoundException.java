...
@Slf4j
@Component
public class CodeGeneratorNotFoundException extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/not-found-exception.template";
    @Override
