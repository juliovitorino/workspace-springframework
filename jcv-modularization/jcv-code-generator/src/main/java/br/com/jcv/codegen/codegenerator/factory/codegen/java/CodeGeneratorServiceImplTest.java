...
@Slf4j
@Component
public class CodeGeneratorServiceImplTest extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/service-impl-test.template";
    @Override
