...
@Slf4j
@Component
public class CodeGeneratorConstantes extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/constantes.template";
    @Override
