...
@Slf4j
@Component
public class CodeGeneratorBuilderModel extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/builder-model.template";
    @Override
