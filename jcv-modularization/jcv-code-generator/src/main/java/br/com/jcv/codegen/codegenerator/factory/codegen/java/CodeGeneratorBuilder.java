...
@Slf4j
@Component
public class CodeGeneratorBuilder extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/builder.template";
    @Override
