...
@Slf4j
@Component
public class CodeGeneratorService extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/service.template";
    @Override
