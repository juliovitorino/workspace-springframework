...
@Slf4j
@Component
public class CodeGeneratorAnalyserException extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/analyser-exception.template";
    @Override
