...
@Slf4j
@Component
public class CodeGeneratorInvalidFormatException extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/invalid-format-exception.template";
    @Override
