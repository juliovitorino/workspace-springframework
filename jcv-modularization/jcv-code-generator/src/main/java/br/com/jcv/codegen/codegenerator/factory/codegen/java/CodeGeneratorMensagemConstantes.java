...
@Slf4j
@Component
public class CodeGeneratorMensagemConstantes extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/mensagem-constantes.template";
    @Override
...
//        writeCode(sbCode,codegen, "/dto/MensagemConstantes","java");
