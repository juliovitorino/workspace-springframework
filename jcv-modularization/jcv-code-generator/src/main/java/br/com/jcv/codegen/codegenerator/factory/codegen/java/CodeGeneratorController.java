...
@Slf4j
@Component
public class CodeGeneratorController extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/controller.template";
    @Override
