...
@Slf4j
@Component
public class CodeGeneratorTansactionJpaConfig extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/transaction-jpa-config.template";
    @Override
