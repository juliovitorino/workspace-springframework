...
@Slf4j
@Component
public class CodeGeneratorRepository extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/repository.template";
    @Override
