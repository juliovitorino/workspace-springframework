...
@Slf4j
@Component
public class CodeGeneratorCommoditieService extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/commoditie-service.template";
    @Override
