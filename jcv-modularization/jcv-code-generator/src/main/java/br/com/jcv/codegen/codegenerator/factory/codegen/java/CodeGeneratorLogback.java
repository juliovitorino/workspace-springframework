...
@Slf4j
@Component
public class CodeGeneratorLogback extends AbstractCodeGenerator implements ICodeGeneratorIndividual {
...
//        writeCode(sbCode,codegen, "/dto/logback","xml");
