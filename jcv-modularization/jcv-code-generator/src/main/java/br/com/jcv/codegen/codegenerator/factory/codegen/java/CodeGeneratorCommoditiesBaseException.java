...
@Slf4j
@Component
public class CodeGeneratorCommoditiesBaseException extends AbstractCodeGenerator implements ICodeGeneratorIndividual {

    private static final String TEMPLATE = "static/commodities-base-exception.template";
    @Override
...
//        writeCode(sbCode,codegen, "/exception/CommoditieBaseException","java");
